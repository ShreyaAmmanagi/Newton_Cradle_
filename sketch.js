...
function setup() {
  ...
  thread0 = new constraints(rect1.body,circle2.body,20,10);
  thread1 = new constraints(rect5.body,circle1.body,20,10);
  thread2 = new constraints(rect2.body,circle3.body,20,10);
  thread3 = new constraints(rect3.body,circle4.body,20,10);
  thread4 = new constraints(rect4.body,circle5.body,20,10);
...
function draw() {
  ...
  thread4.display();
  if(keyDown("up")){
  Matter.Body.applyForce(circle4.body,circle4.body.position,{x:-20,y:-20})
  }
